    ...
    <div class="container mx-auto">
      <header class="md:mb-8 py-4 px-4 flex justify-between items-center select-none">
        ...
        <div class="hidden md:block text-sm">
          <a href="#" class="py-2 px-3 ml-2 hover:bg-indigo-100 rounded">
            Blog
          </a>
          ...
          <a href="#" class="py-2 px-3 ml-2 hover:bg-indigo-400 bg-indigo-500 rounded shadow-lg border text-white">
            Documentation
          </a>
        </div>
      </header>
        ...
        <div class="pb-8 mt-auto">
          <div class="text-center">
            ...
            <div class="mb-6 mt-12">
              <a href="#" class="py-2 px-4 md:py-4 md:px-6 mr-2 border select-none hover:bg-indigo-400 bg-indigo-500 rounded shadow-lg text-white">Why Jesse?</a>

              <a href="#" class="py-2 px-4 md:py-4 md:px-6 border select-none hover:bg-gray-100 bg-white rounded shadow-lg text-indigo-800"> Get Started <span>&rarr;</span> </a>
            </div>
          </div>
        </div>
      </div>
